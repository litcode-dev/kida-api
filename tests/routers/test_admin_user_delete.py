...
@pytest.mark.asyncio
async def test_self_delete_reports_the_user_as_actor(client, db_session, monkeypatch):
    """Same code path as an admin removal, but the actor has to say who asked."""
    from app.tasks import notification_tasks
