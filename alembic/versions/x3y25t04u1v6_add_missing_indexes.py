...
def upgrade() -> None:
    op.create_index("ix_users_onesignal_player_id", "users", ["onesignal_player_id"])
    op.create_index("ix_loops_created_by", "loops", ["created_by"])
    op.create_index("ix_stem_packs_loop_id", "stem_packs", ["loop_id"])
    op.create_index("ix_stem_packs_created_by", "stem_packs", ["created_by"])
    op.create_index("ix_stems_stem_pack_id", "stems", ["stem_pack_id"])
    op.create_index("ix_drum_kits_created_by", "drum_kits", ["created_by"])
    op.create_index("ix_drum_samples_drum_kit_id", "drum_samples", ["drum_kit_id"])
    op.create_index("ix_downloads_loop_id", "downloads", ["loop_id"])
    op.create_index("ix_downloads_stem_id", "downloads", ["stem_id"])
    op.create_index("ix_downloads_drum_kit_id", "downloads", ["drum_kit_id"])
    op.create_index("ix_downloads_drone_pad_id", "downloads", ["drone_pad_id"])
    op.create_index("ix_likes_loop_id", "likes", ["loop_id"])
    op.create_index("ix_likes_stem_pack_id", "likes", ["stem_pack_id"])
    op.create_index("ix_ai_generations_subscription_id", "ai_generations", ["subscription_id"])
    op.create_index("ix_ai_generations_result_loop_id", "ai_generations", ["result_loop_id"])
